...
<head>
    <title>Tasks Assigned - Task Management System | Touch Stack Technologies</title>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
     ...
     <div class="col-md-12 bckToPrev_mrgn">
    <a href="{{ route('dashboard') }}" class="bckToPrev" title="Go Back"><i class="fa fa-arrow-left"></i> Go Back </a>
  </div>                   
...
@foreach($getTasksAssigned as $details)
                                                <tr>
